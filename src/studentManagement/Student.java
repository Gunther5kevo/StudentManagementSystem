...
public class Student extends JFrame {
	...
	public Student() {
		...
		studentId.setFont(new Font("Perpetua Titling MT", Font.BOLD, 14));
		...
		submit.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					String query = "INSERT INTO `student`(`name`, `email`, `Studentid`, `contactnumber`, `homecity`) VALUES (?, ?, ?, ?, ?)";
					...
					pst.setString(2, semail.getText());
					pst.setString(3, sStudentid.getText());
					pst.setString(4, scontact.getText());
					pst.setString(5, shome.getText());
					if(sname.getText().equals("") || semail.getText().equals("") || sStudentid.getText().equals("") || scontact.getText().equals("") || shome.getText().equals("")) {
						...
						.addGroup(gl_contentPane.createSequentialGroup()
							...
							.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
								...
								.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING, false)
									.addComponent(sStudentid)
									.addComponent(sname)
									.addComponent(semail, GroupLayout.DEFAULT_SIZE, 240, Short.MAX_VALUE)))
							.addGap(34))
						.addGroup(gl_contentPane.createSequentialGroup()
